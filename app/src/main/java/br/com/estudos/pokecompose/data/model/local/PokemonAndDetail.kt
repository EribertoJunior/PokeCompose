package br.com.estudos.pokecompose.data.model.local

import androidx.room.Embedded
import androidx.room.Relation
import br.com.estudos.pokecompose.data.dataBase.local.entities.EvolutionChain
import br.com.estudos.pokecompose.data.dataBase.local.entities.EvolutionChain.Companion.EVOLUTION_CHAIN_ID
import br.com.estudos.pokecompose.data.dataBase.local.entities.Pokemon
import br.com.estudos.pokecompose.data.dataBase.local.entities.Pokemon.Companion.POKEMON_ID
import br.com.estudos.pokecompose.data.dataBase.local.entities.PokemonDetail
import br.com.estudos.pokecompose.data.dataBase.local.entities.PokemonDetail.Companion.POKEMON_DETAIL_OWNER_ID
import br.com.estudos.pokecompose.data.dataBase.local.entities.PokemonSpecies
import br.com.estudos.pokecompose.data.dataBase.local.entities.PokemonSpecies.Companion.POKEMON_SPECIES_EVOLUTION_CHAIN_ID
import br.com.estudos.pokecompose.data.dataBase.local.entities.PokemonSpecies.Companion.POKEMON_SPECIES_OWNER_ID
